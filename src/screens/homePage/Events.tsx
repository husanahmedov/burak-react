            ...
            return (
              <SwiperSlide key={number} className={"events-info-frame"}>
                <div className={"events-img"}>
                  <img src={value.img} className={"events-img"} alt="nomage" />
                </div>
                    ...
                    <Box className={"bott-left"}>
                      <div className={"event-title-speaker"}>
                        ...
                        <div className={"event-organizator"}>
                          <img src={"/icons/speaker.svg"} alt="noimage" />
                      ...
                      <div className={"bott-info"}>
                        <div className={"bott-info-main"}>
                          <img src={"/icons/calendar.svg"} alt="noimage" />
                          {value.date}
                        </div>
                        <div className={"bott-info-main"}>
                          <img src={"/icons/location.svg"} alt="noimage" />
                          {value.location}
                        </div>
                      </div>
                    </Box>
